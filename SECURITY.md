...
Репозиторий распространяет **текстовые инструкции** (Cursor Skill, промпт, шаблоны
`llms.txt`). Он не устанавливает серверные агенты, не скачивает зависимости при
использовании и не имеет исполняемого рантайма продукта.
