...
Also: [`PROMPT.md`](PROMPT.md) (default) / [`PROMPT.ru.md`](PROMPT.ru.md)
(any chat UI), [`template-llms.txt`](template-llms.txt),
[`example-llms.txt`](example-llms.txt) (golden curated sample for
blog.bezpalov.com).
...
| Claude / ChatGPT and other chat UIs | Use `PROMPT.md` / `PROMPT.ru.md`, or paste the relevant `SKILL.md` |
...
1. For llms.txt alone — use [`PROMPT.md`](PROMPT.md) (English) or
...
[SECURITY.md](SECURITY.md). Russian mirrors: [`README.ru.md`](README.ru.md),
