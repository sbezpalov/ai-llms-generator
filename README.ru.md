...
Также: [`PROMPT.md`](PROMPT.md) (EN по умолчанию) /
[`PROMPT.ru.md`](PROMPT.ru.md), [`template-llms.txt`](template-llms.txt),
[`example-llms.txt`](example-llms.txt) (golden curated sample для
blog.bezpalov.com).
...
| Claude / ChatGPT и другие чаты | Использовать `PROMPT.md` / `PROMPT.ru.md` либо вставить нужный `SKILL.md` |
...
источник истины — [`AGENTS.md`](AGENTS.md) (EN). См. [CONTRIBUTING.md](CONTRIBUTING.md),
[SECURITY.md](SECURITY.md); по-русски —
[`CONTRIBUTING.ru.md`](CONTRIBUTING.ru.md), [`SECURITY.ru.md`](SECURITY.ru.md),
[`AGENTS.ru.md`](AGENTS.ru.md).
