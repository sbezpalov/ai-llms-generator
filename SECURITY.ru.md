...
Английская версия по умолчанию: [`SECURITY.md`](SECURITY.md).

Чтобы сообщить об уязвимости, используйте GitHub **Report a vulnerability** на
вкладке Security или напишите на email для чувствительных случаев. Подробности
ниже.
...
структуру — сеть не трогает (кроме локального запуска aio-lint на offline
fixtures).
